...
Empty Parameter
    [template]  Adding hero
    --Empty_Natid     ${None}     super man        m           01012001        100         0           500     "wrong status code"
    --Empty_Name      nid-12345   ${None}          m           01012001        100         0           500     "wrong status code"
    --Empty_Gender    nid-12345   super man        ${None}     01012001        100         0           500     "wrong status code - Should not be successful"
    --Empty_Birthday  nid-12345   super man        m           ${None}         100         0           500     "wrong status code"
    --Empty_Salary    nid-12345   super man        m           01012001        ${None}     0           500     "wrong status code"
    --Empty_Tax       nid-12345   super man        m           01012001        100         ${None}     500     "wrong status code"
...
Gender Limit Test
    ...
    --Gender Character                 nid-12345   Super man     male      01012001        100     0       500     "wrong status code - Gender should not be string"
...
Valid Parameters
    [template]  Adding hero
    --Valid     nid-12345   Super man     m       01012001        100       10     202     ""
